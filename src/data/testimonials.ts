...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote:
      'The roof had black streaks running down both slopes. They soft washed it and it came back to the original shingle color with zero pressure damage. Two years later it still looks great.',
    name: 'Susan &amp; Bill T.',
    location: 'Spooner, WI',
